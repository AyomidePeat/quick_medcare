    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const SizedBox(height: 20),
          InfoTextField(controller: dobController, hint: 'DOB'),
          const SizedBox(height: 20),
          ...
          const SizedBox(height: 20),
          InfoTextField(
              controller: pastConditionsController, hint: 'Past Conditions'),
          const SizedBox(height: 20),
          ...
          const SizedBox(height: 20),
          InfoTextField(
              controller: symptomDurationController, hint: 'Symptoms Duration'),
          const SizedBox(height: 20),
          InfoTextField(
              controller: symptomSeverityController, hint: 'Symptom Severity'),
          const SizedBox(height: 20),
